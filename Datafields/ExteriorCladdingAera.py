...
df = pd.read_excel('D:/DigiCrome/Project1/DatasetDescription/test.xlsx')
...
X = df[['ExteriorCladdingArea']]  # Features
y = df['ExteriorCladdingArea']  # Target variable
...
# You can use the trained model to predict Masonry veneer area for new data
